        ...
        <div className="relative">
            <div className="_container pb-[83px] pt-[156px] md:pt-[100px] md:pb-0">
                <div className="grid grid-cols-2 gap-10 md:grid-cols-1 sm:overflow-hidden">
                    <div className="max-w-[458px] md:text-center md:max-w-none">
                        ...
                        <Button
                            text="GET IN TOUCH"
                            className="text-white bg-black sm:text-[17px] sm:py-[10px] sm:px-[67px] sm:bg-white sm:text-black"
                            onClick={() => {
                                document.querySelector(".connect")?.scrollIntoView({ block: "center", behavior: "smooth" });
                            }}
                        />
                    </div>
            ...
            <div className="absolute right-0 top-0 bottom-0 w-[40%] bg-black -z-10 md:w-[375px] md:h-[447px] md:-left-[175px] md:top-[370px]"></div>
        </div>
    );
}
